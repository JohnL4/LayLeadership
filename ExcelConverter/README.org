...
* Roadmap
  ...
  https://github.com/JohnL4/LayLeadership/projects/1.)
...
** How to activate
   ...
   Specify as ~-Djava.util.logging.config.file=./logging.properties~ option to ~java~ command (on the command line)
   /before/ the ~-jar excel-converter-1.0-SNAPSHOT.jar~ part.
