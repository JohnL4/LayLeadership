* Overview
  ...
  This repo is intended to capture my notes and various bits of software I write to help my Methodist church's Lay
  Leadership committee.

  In a Methodist church, the Lay Leadership committee is a committee comprised of lay members and led by one of the
  clergy (head pastor?) whose job it is to recruit other lay members to server on all church committees.  It's kind of a
